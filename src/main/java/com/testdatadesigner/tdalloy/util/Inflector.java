 ...
 * inspired by the <a href="http://api.rubyonrails.org/classes/Inflector.html">Inflector</a> class in
 * <a href="http://www.rubyonrails.org">Ruby on Rails</a>, which is distributed under the
...
public class Inflector {
   ...
   * </p>
   * <p>
   * Note that if the {@link Object#toString()} is called on the supplied object, so this method works for non-strings,
   * too.
   * </p>
   * 
   * @param word
  ...
  /**
   * Converts strings to lowerCamelCase. This method will also use any extra delimiter characters to identify word
   * boundaries.
   * <p>
   * Examples:
   * 
  ...
  /**
   * Converts strings to UpperCamelCase. This method will also use any extra delimiter characters to identify word
   * boundaries.
   * <p>
   * Examples:
   * 
  ...
  /**
   * Capitalizes the first word and turns underscores into spaces and strips trailing "_id" and any supplied removable
   * tokens. Like {@link #titleCase(String, String[])}, this is meant for creating pretty output.
   * <p>
   * Examples:
   * 
   * <pre>
  ...
  /**
   * Capitalizes all the words and replaces some characters in the string to create a nicer looking title. Underscores
   * are changed to spaces, a trailing "_id" is removed, and any of the supplied tokens are removed. Like
  ...
  /**
   * Turns a non-negative number into an ordinal string used to denote the position in an ordered sequence, such as 1st,
   * 2nd, 3rd, 4th.
   * 
   * @param number
  ...
  /**
   * Utility method to replace all occurrences given by the specific backreference with its uppercased form, and remove
   * all other backreferences.
   * <p>
