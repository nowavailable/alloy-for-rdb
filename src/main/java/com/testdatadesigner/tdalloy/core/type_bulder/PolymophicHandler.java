...
public class PolymophicHandler {
    ...
    public List<Relation> buildRelation(Function<String, Sig> sigSearchByName,
        ...
        valueRelation.owner = sigSearchByName.apply(RulesForAlloyable
                .tableSigName(ownerTableName));
        valueRelation.refToTypes = Arrays.asList(dummyRefToSigs.get(0),
                dummyRefToSigs.get(1));
        ...
        relForDummy1.name = RulesForAlloyable
                .foreignKeyNameReversed(ownerTableName,
                        dummyRefToSigs.get(0).name);
        ...
        polymRelationReversed.name = "refTo_"
                + RulesForAlloyable.tableSigName(ownerTableName);
        polymRelationReversed.refTo = sigSearchByName.apply(RulesForAlloyable
                .tableSigName(ownerTableName));
        polymRelationReversed.reverseOfrefToTypes = Arrays.asList(
                dummyRefToSigs.get(0), dummyRefToSigs.get(1));
        ...
        polymImpleRel_1.name = RulesForAlloyable
                .singularize(dummyRefToSigs.get(0).name);
        ...
        polymImpleRel_2.name = RulesForAlloyable
                .singularize(dummyRefToSigs.get(1).name);
