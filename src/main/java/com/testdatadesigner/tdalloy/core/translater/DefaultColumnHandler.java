...
public class DefaultColumnHandler {
  ...
  public IRelation buildRelation(Function<String, IAtom> atomSearchByName, String ownerTableName, String columnName)
  ...
  public PolymorphicAbstract buildAtomPolymorphicAbstract(Function<String, IAtom> atomSearchByName,
      String ownerTableName, String columnName) throws IllegalAccessException {
